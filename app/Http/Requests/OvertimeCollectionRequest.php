...
class OvertimeCollectionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'filter.approvedAt.gt' => 'sometimes|date',
            'filter.approvedAt.gte' => 'sometimes|date',
            'filter.approvedAt.lt' => 'sometimes|date',
            'filter.approvedAt.lte' => 'sometimes|date',
        ];
    }
}
