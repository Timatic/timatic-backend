...
test('periods that touch but do not overlap are not overlapping', function () {
    $first = new Period(Carbon::parse('2026-07-16 09:00'), Carbon::parse('2026-07-16 10:00'));
    $second = new Period(Carbon::parse('2026-07-16 10:00'), Carbon::parse('2026-07-16 11:00'));
...
test('a period overlapping another partially is overlapping', function () {
    $first = new Period(Carbon::parse('2026-07-16 09:00'), Carbon::parse('2026-07-16 10:30'));
    $second = new Period(Carbon::parse('2026-07-16 10:00'), Carbon::parse('2026-07-16 11:00'));
...
test('a period covers another when it fully contains it', function () {
    $outer = new Period(Carbon::parse('2026-07-16 09:00'), Carbon::parse('2026-07-16 12:00'));
    $inner = new Period(Carbon::parse('2026-07-16 10:00'), Carbon::parse('2026-07-16 11:00'));
...
test('subtracting a blocker in the middle splits the period in two segments', function () {
    $period = new Period(Carbon::parse('2026-07-16 09:00'), Carbon::parse('2026-07-16 12:00'));
    $blocker = new Period(Carbon::parse('2026-07-16 10:00'), Carbon::parse('2026-07-16 11:00'));
...
test('subtracting a covering blocker leaves no segments', function () {
    $period = new Period(Carbon::parse('2026-07-16 10:00'), Carbon::parse('2026-07-16 11:00'));
    $blocker = new Period(Carbon::parse('2026-07-16 09:00'), Carbon::parse('2026-07-16 12:00'));

    expect($period->subtract(collect([$blocker])))->toBeEmpty();
});

test('subtracting an overlapping blocker trims the period', function () {
    $period = new Period(Carbon::parse('2026-07-16 09:00'), Carbon::parse('2026-07-16 11:00'));
    $blocker = new Period(Carbon::parse('2026-07-16 08:00'), Carbon::parse('2026-07-16 10:00'));
